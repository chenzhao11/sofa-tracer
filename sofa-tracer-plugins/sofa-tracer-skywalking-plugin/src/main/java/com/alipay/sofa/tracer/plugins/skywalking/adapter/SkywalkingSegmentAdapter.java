...
public class SkywalkingSegmentAdapter {
    public SegmentObject convertToSkywalkingSegment(SofaTracerSpan sofaTracerSpan) {
        ...
        SegmentObject segmentObject= SegmentObject.newBuilder()
                ...
                .setService(constructServiceName(sofaTracerSpan))
                .setServiceInstance(constructServiceInstanceName(sofaTracerSpan))
                .addSpans(entrySpan)
                .build();
    ...
    private SpanObject constructEntrySpan(SofaTracerSpan sofaTracerSpan){
        ...
        SpanObject.Builder entrySpanBuilder= SpanObject.newBuilder()
                .setSpanId(0)
                .setParentSpanId(-1)
                ...
                //单元测试中也需要创建Tracer对象
                .setComponentId(ComponentName2ComponentId.componentName2IDMap.get(sofaTracerSpan.getSofaTracer().getTracerType()))
        ...
        //设置parent segments
        SegmentReference segmentReference = SegmentReference.newBuilder()
                //全部都设置成跨进程的？？
                ...
                .setParentSpanId(0)
                .setParentService("a目前父组件的serviceNme还取不到？？")
                ...
                .setNetworkAddressUsedAtPeer("按照127.0.0.1:8080的格式组织的，目前也是还没有找到对应字段！！")
                .build();
