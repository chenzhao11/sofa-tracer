...
import com.alipay.sofa.tracer.plugins.jaeger.JaegerSofaTracerSpanRemoteReporterHttp;
...
public class JaegerSofaTracerSpanRemoteReporterHttpTest {
    ...
    public void testSpanReport() throws TTransportException {
        ...
        JaegerSofaTracerSpanRemoteReporterHttp remoteReporter = new JaegerSofaTracerSpanRemoteReporterHttp(
                "127.0.22.1", 6331, 0, "testService");
    ...
    public void testCommandQueueSetting() throws TTransportException {
        JaegerSofaTracerSpanRemoteReporterHttp reporter = new JaegerSofaTracerSpanRemoteReporterHttp(
            "127.0.22.1", 6331, 0, "testService");
